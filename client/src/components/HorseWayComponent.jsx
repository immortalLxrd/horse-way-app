	...
	return (
		<li className='mt-8'>
			<div className="flex justify-between mb-1">
				...
				<span className="text-base text-lg font-bold text-black-700">{horse.distance}</span>
			</div>
			<div className="w-full bg-gray-200 rounded-full h-8">
				<div
					className={[horseClassColors[index],
						'transition-all ease-out duration-1000 h-8 rounded-full flex items-center justify-end']
						.join(' ')
					}
